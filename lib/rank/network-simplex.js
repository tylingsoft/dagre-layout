...
function calcCutValue (t, g, child) {
  ...
  __.each(g.nodeEdges(child), function (e) {
...
function dfsAssignLowLim (tree, visited, nextLim, v, parent) {
  ...
  visited[v] = true
  __.each(tree.neighbors(v), function (w) {
    if (!__.has(visited, w)) {
...
function leaveEdge (tree) {
  return __.find(tree.edges(), function (e) {
...
function enterEdge (t, g, edge) {
  ...
  const candidates = __.filter(g.edges(), function (edge) {
...
function updateRanks (t, g) {
  const root = __.find(t.nodes(), function (v) { return !g.node(v).parent })
