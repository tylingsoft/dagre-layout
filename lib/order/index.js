...
function order (g) {
  ...
  const downLayerGraphs = buildLayerGraphs(g, __.range(1, maxRank + 1), 'inEdges')
  const upLayerGraphs = buildLayerGraphs(g, __.range(maxRank - 1, -1, -1), 'outEdges')
...
function buildLayerGraphs (g, ranks, relationship) {
  return __.map(ranks, function (rank) {
